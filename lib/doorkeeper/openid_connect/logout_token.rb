...
module Doorkeeper
  module OpenidConnect
    ...
    # that ("A Logout Token MUST contain either a sub or a sid Claim, and MAY
    # contain both") and defines what it means: "If a sid Claim is not present,
    # the intent is that all sessions at the RP for the End-User identified by
