...
# prepend undone. There would be no load error to catch it, and eager loading
# would not catch it either, because forcing the autoload is exactly what makes
# the prepend happen in that process.
#
